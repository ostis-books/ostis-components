...
base_path=../search_mark.component/src
...
cp -Rfv $base_path/components/search_mark/static/* $sc_web_static_path

stage "Install component"

append_js $sc_web_path/templates/components.html components/js/search_mark/search_mark.js
