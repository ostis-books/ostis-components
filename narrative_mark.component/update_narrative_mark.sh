...
base_path=../narrative_mark.component/src
...
cp -Rfv $base_path/components/narrative_mark/static/* $sc_web_static_path

stage "Install component"

append_js $sc_web_path/templates/components.html components/js/narrative_mark/narrative_mark.js
